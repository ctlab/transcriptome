...
public class FixesStatistics {
    public static void main(String[] args) throws IOException {
        ...
        for (String file : args) {
            ...
            System.err.println("loading from " + file + ": " + timer.finish());
            ...
            fixes = null;
            System.err.println("iterating: " + timer.finish());
            ...
            */
            ...
            System.err.println(file + ": " + timer.finish());
            System.err.println("set.size: " + set.size());
        }

        System.err.println("total time: " + total.finish());
