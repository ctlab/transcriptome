...
public class BinqTruncate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger.info("Al truncating done");
        logger.info("Total time = " + t + ", total sumTrustLen / sumLen = " + sumTrustLen / (double) sumLen);
